    ...
    <div>
      ...
      <section style={{backgroundColor: '#fffbe8'}}>
        <div className="text-center py-12 px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-oswald font-normal tracking-wide leading-tight mb-6">
            <span style={{color: '#11100f'}}>CELEBRATING 10 YEARS OF</span>
            <br />
      ...
      <section className="relative w-full">
        ...
        <img
          ...
          style={{height: '450px', objectPosition: '10% 15%'}}
        />
        <div className="absolute top-0 right-0 w-full md:w-[55%] h-full flex items-center justify-end">
          ...
          <div className="hidden md:block relative z-10 p-6 lg:p-10 lg:pl-14" style={{maxWidth: '85%', marginLeft: 'auto'}}>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8" style={{backgroundColor: '#fffbe8'}}>
        <div className="max-w-4xl mx-auto">
          <p className="font-source-sans text-base lg:text-lg leading-[1.6] text-justify mb-4" style={{color: '#4b4b4b'}}>
            <strong>What matters most — to us and to the dogs — is how Jess applies all of this knowledge.</strong> She has a calm, thoughtful presence that dogs respond to immediately, and she has a gift for helping families understand how training creates confidence, trust, and true partnership at home. As we celebrate ten years of training on the Bluff, Jess represents the next chapter of our program — honoring what has always worked while helping us continue to grow.
          </p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl md:text-5xl font-oswald font-normal mb-4 tracking-wide text-center uppercase" style={{color: '#11100f'}}>
