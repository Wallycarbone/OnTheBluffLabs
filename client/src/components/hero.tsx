...
import behaviorAcademyImage from "@assets/Puppies 5x4 (4 x 4 in) (24)_1756668372760.jpg";
...
export default function Hero() {
  ...
  return (
    <>
      <section 
        id="home" 
                className="h-[90vh] md:h-screen relative overflow-hidden"
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        <img 
          ...
          style={{ objectPosition: '82.5% 100%', transform: 'translateY(-7%)' }}
          onError={(e) => {
        ...
        <div 
          ...
          style={{
            background: 'linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 40%, rgba(0, 0, 0, 0.6) 55%, rgba(0, 0, 0, 0.9) 100%)'
          }}
        ></div>
      </div>
      
      {/* Content Overlay - Responsive positioning */}
      <div className="relative z-20 h-[90vh] md:h-screen flex items-end md:items-center">
