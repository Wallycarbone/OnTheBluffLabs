...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-brand-charcoal to-brand-medium-gray" style={{background: 'linear-gradient(to bottom right, #11100f, #4b4b4b)'}}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start mb-6">
              <Award className="w-8 h-8 mr-3" style={{color: '#e3b404'}} />
              <span className="font-montserrat font-semibold text-lg" style={{color: '#e3b404'}}>
                50+ Years of Excellence
              </span>
            </div>
            <h1 className="text-4xl md:text-6xl font-playfair font-bold mb-6" style={{color: '#fefefe'}}>
              On The Bluff Labradors
            </h1>
            <p className="text-xl md:text-2xl mb-8 font-light" style={{color: '#ebebeb'}}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button 
                ...
                style={{borderColor: '#fefefe', color: '#fefefe'}}
                onMouseEnter={(e) => {e.currentTarget.style.backgroundColor = '#fefefe'; e.currentTarget.style.color = '#11100f'}}
                onMouseLeave={(e) => {e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.color = '#fefefe'}}
              >
                Contact Us
              </Button>
            </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-4 -right-4 rounded-lg px-4 py-2 shadow-lg" style={{backgroundColor: '#fefefe'}}>
                <p className="font-montserrat font-semibold text-sm" style={{color: '#11100f'}}>Meet Atticus</p>
                <p className="text-xs" style={{color: '#4b4b4b'}}>English Labrador</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-4">
              <Heart className="w-6 h-6 mr-2" style={{color: '#e3b404'}} />
              <h2 className="text-3xl md:text-4xl font-playfair font-bold" style={{color: '#fefefe'}}>
                Stories from Our Families
              </h2>
            </div>
            <p className="max-w-2xl mx-auto" style={{color: '#ebebeb'}}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredTestimonials.map((testimonial, index) => (
              <Card key={index} className="rounded-xl shadow-lg hover:shadow-xl transition-shadow" style={{backgroundColor: '#fefefe'}}>
                <CardContent className="p-6">
                  ...
                  <p className="mb-4 italic font-source-sans" style={{color: '#4b4b4b'}}>
                    "{testimonial.testimonial}"
                  </p>
                  <div className="border-t pt-4">
                    <h4 className="font-playfair font-bold mb-1" style={{color: '#11100f'}}>
                      {testimonial.name}
                    </h4>
