        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-4xl md:text-5xl font-oswald font-normal mb-6 tracking-wide leading-tight" style={{color: '#11100f'}}>
            ...
            <div className="max-w-4xl mx-auto mb-12">
              <p className="font-source-sans text-xl leading-relaxed mb-8" style={{color: '#4b4b4b'}}>
              ...
              <p className="font-source-sans text-xl leading-relaxed mb-0" style={{color: '#4b4b4b'}}>
