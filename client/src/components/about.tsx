...
export default function About() {
  const features = [
    ...
    {
      icon: Award,
      title: "Strong Training Foundation",
    },
  ];

  return (
    <section id="about" className="py-24" style={{backgroundColor: '#fefefe'}}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg mb-6 font-source-sans" style={{color: '#4b4b4b'}}>
              For decades, we have been committed to breeding exceptional Labrador Retrievers that embody the breed's finest qualities: intelligence, loyalty, and gentle temperament. Our holistic philosophy encompasses every aspect of development - from selective breeding of champion bloodlines to nourishing each dog with a raw diet for optimal health and employing gentle training methods that honor their natural temperament.
            </p>
